...
/**
 * Adds entry to the buffer and returns the buffptr of the entry that was
 * overwritten (when the buffer was already full), or NULL if no entry was
 * evicted.  The caller must free the returned pointer when non-NULL.
 */
